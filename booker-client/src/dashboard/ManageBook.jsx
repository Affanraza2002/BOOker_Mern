  ...
  //delete a books
   const handleDelete =(id) =>{
    ...
    fetch(`http://localhost:3000/book/${id}`,{
      method: "DELETE",
    }).then(res => res.json()).then(data => {alert("Book Succesfully Deleted")
          });
   }
  return (
    <div className='px-4 my-12 '>
      ...
      <div className="absolute bg-white dark:bg-black  top-0 left-0 rounded-lg drop-shadow-md -z-10">
        ...
        </Table.Head>
        {
          ...
          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
            ...
            <Table.Cell>
              ...
              <button onClick={()=> handleDelete(book._id)} className='bg-red-600 px-4 py-1 font-semibold text-white rounded hover:bg-sky-600'>Delete</button>
            </Table.Cell>
          </Table.Row>
          </Table.Body>)
        }
